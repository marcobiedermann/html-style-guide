...
gulp.task('css', () =>
  gulp
    .src(`${dirs.source}/assets/css/style.css`)
...
gulp.task('copy', () => gulp.src(`${dirs.source}/**/*.txt`).pipe(gulp.dest(`${dirs.dest}`)));
...
gulp.task('images', () =>
  gulp
    .src(`${dirs.source}/**/*.{gif,ico,jpg,jpeg,png}`)
    .pipe(gulpImagemin())
    .pipe(gulp.dest(`${dirs.dest}`)),
);
...
gulp.task('build', gulp.parallel('lint', 'css', 'html', 'js', 'json', 'images', 'svg', 'copy'));
